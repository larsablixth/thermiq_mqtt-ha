...
id_names: dict[str, list[str]] = {
    ...
    "indoor_dec_t": [
        "Indoor temp., decimal",
        "Rumstemp. är, decimal",
        "Huonelämpötila, desimaalit",
        "Romstemp. er, desimal",
        "Innentemp., Ist, decimal",
    ],
    "indoor_target_t": [
        "Indoor target temp.",
        "Rumstemp. bör",
        ...
        "Romstemp. bør",
        "Innentemperatur, Soll",
    ],
    "indoor_target_dec_t": [
        "Indoor target temp., decimal",
        "Rumstemp. bör, decimal",
        "Haluttu huonelämpötila, desimaalit",
        "Romstemp. bør, desimal",
        "Innentemp., Soll, decimal",
    ],
    "supplyline_t": [
        "Supplyline temp.",
        "Framledningstemp.",
    ...
    "brine_out_t": [
        "Brine out temp.",
        "Brine ut temp.",
        "Keruupiirin menolämpötila",
        "Brine ut temp.",
        "Soleablasstemperatur",
    ],
    "brine_in_t": [
        "Brine in temp.",
        "Brine in temp.",
        "Keruupiirin tulolämpötila",
        "Brine inn temp.",
        "Soleeinlasstemperatur",
    ],
    "cooling_t": [
        "Cooling temp.",
        "Kylning temp.",
    ...
    "supplyline_target_t": [
        "Supplyline target temp.",
        "Framledningstemp., bör",
    ...
    "highpressure_alm": [
        "Alarm highpr.pressostate",
        "Larm högtr.pressostat",
        "Hälytys korkeapainesäädin",
        "Alarmhøytr.pressostat",
        "Alarm Hochdruckpressostat",
    ],
    "lowpressure_alm": [
        "Alarm lowpr.pressostate",
        "Larm lågtr.pressostat",
        "Hälytys matalapainesäädin",
        "Alarmlavtr.pressostat",
        "Alarm Niedrigdruckpressostat",
    ],
    "motorbreaker_alm": [
        "Alarm motorcircuit breaker",
        "Larm motorskydd",
        "Hälytys moottorisuoja",
        "Alarmmotorvern",
        "Alarm Motorschutz",
    ],
    "brine_flow_alm": [
        "Alarm low flow brine",
        "Larm lågflöde brine",
        "Hälytys heikkovirtaus keruuliuos",
        "Alarmlavflyt brine",
        "Alarm Niedrigströmung, Sole",
    ],
    "brine_temperature_alm": [
        "Alarm low temp. brine",
        "Larm lågtemp. brine",
        "Hälytys keruuliuoksen matala lämpötila",
        "Alarmlavtemp. brine",
        "Alarm Niedrigtemperatur, Sole",
    ],
    "outdoor_sensor_alm": [
        "Alarm outdoor t-sensor",
        "Larm utegivare",
        "Hälytys ulkoanturi",
        "Alarmutegiver",
        "Alarm Außenfühler",
    ],
    "supplyline_sensor_alm": [
        "Alarm supplyline t-sensor",
        "Larm framledn.givare",
        "Hälytys lämmityksen menoanturi",
        "Alarmtur.giver",
        "Alarm Vorlauffühler",
    ],
    "returnline_sensor_alm": [
        "Alarm returnline t-sensor",
        "Larm returledn.givare",
        "Hälytys lämmityksen paluuanturi",
        "Alarmretur.giver",
        "Alarm Rücklauffühler",
    ],
    "boiler_sensor_alm": [
        "Alarm hotw. t-sensor",
        "Larm varmvattengivare",
        "Hälytys lämminvesianturi",
        "Alarmvarmtvannsgiver",
        "Alarm Warmwasserfühler",
    ],
    "indoor_sensor_alm": [
        "Alarm indoor t-sensor",
        "Larm rumsgivare",
        "Hälytys huoneanturi",
        "Alarmromgiver",
        "Alarm Innenfühler",
    ...
    "phase_order_alm": [
        "Alarm incorrect 3-phase order",
        "Larm fel fasföljd",
        "Hälytys väärä vaihejärjestys",
        "Alarmfeilfasefølge",
        "Alarm falsche Phasenfolge",
    ],
    "overheating_alm": [
        "Alarm overheating",
        "Larm överhettningsskydd",
        "Hälytys ylikuumenemissuoja",
        "Alarmoveropphetningsvern",
        "Alarm Überhitzungsschutz",
    ],
    ...
    "integral1_a_step": [
        "Integral, reached A-limit",
        "Integral, uppnådd A-gräns",
        "Integraali, A-raja-arvo saavutettu",
        "Integral, oppnådd A-grense",
        "Integral, A-Grenzschritte",
    ],
    "defrost_time_m": ["Defrost", "Avfrostning", "Sulatus", "Defrost", "Defrost"],
    "time_to_start_min_m": [
        "Minimum time to start",
        "Minimum tid till start",
        "Pienin aika käynnistymiseen",
        "Minimum tid til start",
        "Mindestzeit bis Start",
    ],
    "sw_version": [
        "Program version",
        "Programversion",
    ...
    "outdoor_stop_t": [
        "Outdoor stop temp. (20=-20C)",
        "Utestopp temp, (20=-20C)",
        "Ulkolämpötila pysäytys (20=-20C)",
        "Ute stop temp. (20=-20C)",
        "Außentemp. Stop (20=-20C)",
    ],
    "pressure_pipe_limit_t": [
        "Pressurepipe, temp. limit",
        "Tryckrör, temp.gräns",
        "Paineputki, lämpöraja",
        "Trykkrør, temp.grense",
        "Druckrohr, Temperaturgrenze",
    ],
    "hotwater_start_t": [
        "Hotwater starttemp.",
        "Varmvatten starttemp.",
        "Lämminvesituotanto alkulämpötila",
        "Varmtvann starttemp.",
        "Warmwasser, Starttemperatur",
    ],
    "hotwater_runtime_m": [
        "Hotwater operating time",
        "Varmvattentid",
        "Lämminvesi aika",
        "Varmtvanntid",
        "Warmwasserzeit",
    ...
    "legionella_interval_d": [
        "Legionella interval",
        "Legionella intervall",
        "Legionella toiminnon väli",
        "Legionella intervall",
        "Legionella, Intervall",
    ],
    "legionella_stop_t": [
        "Legionella stop temp.",
        "Legionella stopptemp.",
        "Legionellatoiminnon pysäytyslämpötila",
        "Legionella stopptemp.",
        "Legionella, Stopptemperatur",
    ],
    "integral1_a_limit": [
        "Integral limit A1",
        "Integralgräns A1",
    ...
    "integral1_hysteresis_t": [
        "Hysteresis A1",
        "Hysteresgräns A1",
        "Hystereesiraja lämpöpumppu A1",
        "Hysteresegrense A1",
        "Hysterese A1",
    ],
    "returnline_max_t": [
        "Returnline temp., max limit",
        "Returledningstemp., maxgräns",
        "Paluuveden lämpötilan ylänraja",
        "Returtemp., maksgrense",
        "Rücklauftemperatur, Maxgrenze",
    ],
    "start_interval_min_m": [
        "Minimum start interval",
        "Minimum startintervall",
        "Pienin käynnistysväli",
        "Minimum startintervall",
        "Minimum Startintervall",
    ],
    "brine_min_t": [
        "Brinetemp., min limit (-15=OFFV)",
        "Brinetemp., min.gräns (-15=AV)",
        "Keruulämpötilan alaraja (-15 pois päältä)",
        "Brinetemp., min.grense (-15",
        "Soletemperatur, Mingrenze (-15=aus)",
    ],
    "cooling_target_t": [
        "Cooling, target",
        "Kyla, bör",
        "Jäähdytys haluttu lämpötila",
        "Kjøling, bør",
        "Kühlung, Soll",
    ],
    "integral2_a_limit": [
    ...
    "integral2_hysteresis_t": [
        "Hysteresis limit A2",
        "Hysteresgräns A2",
        "Hystereesiraja lisälämpö",
        "Hysteresegrense, Tilskudd",
        "Hysterese, Zusatz",
    ],
    "elect_boiler_steps_max": [
        "Max Electric steps",
        "Max steg, tillsats",
        "Max. lisälämmön portaat",
        "Maks steg, Tilskudd",
        "Maximum Stufen, Zusatz",
    ],
    "current_consumption_max_a": [
        "Electrical current, max limit",
        "Strömförbrukn., maxgräns",
        "Virrankulutuksen yläraja",
        "Strømforbrukn., maksgrense",
        "Stromverbrauch, Maxgrenze",
    ],
    "shunt_time_s": [
        "Shunt time",
        "Shunttid",
    ...
    "hotwater_stop_t": [
        "Hotwater stop temp.",
        "Varmvatten stopptemp.",
        "Lämminvesi pysäytyslämpötila",
        "Varmtvann stopptemp.",
        "Warmwasserstopptemperatur",
    ],
    "manual_test_mode_on": [
        "Manual test mode",
        "Manuell test läge",
    ...
    "factory_reset_req": [
        ...
        "Fabrikks instillinger",
        "Werkseinstellung",
    ],
    "runtime_counters_reset_req": [
        "Reset runtime counters",
        "Nollställ drifttider",
        "Nollaa käyntiajat",
        "Nullstill drifttider",
        "Nullstellung Laufzeiten",
    ],
    "outdoor_sensor_offset_t": [
        "Calibration outdoor sensor",
        "Kalibrering utegivare",
        "Ulkoanturin kalibrointi",
        "Kalibrering utegiver",
        "Kalibrierung Außenfühler",
    ],
    "supplyline_sensor_offset_t": [
        "Calibration supplyline sensor",
        "Kalibrering framledn.givare",
        "Menoanturin kalibrointi",
        "Kalibrering tur.giver",
        "Kalibrierung Vorlauffühler",
    ],
    "returnline_sensor_offset_t": [
        "Calibration returnline sensor",
        "Kalibrering returledn.givare",
        "Paluuanturin kalibrointi",
        "Kalibrering retur.giver",
        "Kalibrierung Rücklauffühler",
    ],
    "boiler_sensor_offset_t": [
        "Calibration hotwater sensor",
        "Kalibrering varmvattengivare",
        "Lämminvesianturin kalibrointi",
        "Kalibrering Varmtvanngiver",
        "Kalibrierung Warmwasserfühler",
    ],
    "brine_in_sensor_offset_t": [
        "Calibration brine out sensor",
        "Kalibrering brine ut",
        "Keruu menoanturin kalibrointi",
        "Kalibrering brine ut",
        "Kalibrierung Soleablass",
    ],
    "brine_out_sensor_offset_t": [
        "Calibration brine in sensor",
        "Kalibrering brine in",
        "Keruu paluuanturin kalibrointi",
        "Kalibrering Brine inn",
        "Kalibrierung Soleeinlass",
    ],
    "heatingsystem_type": [
        "Heating system type 0=VL 4=D",
        "Värmesystemtyp 0=VL 4=D",
        "Lämmitysjärjestelmän tyyppi 0=VL 4=D",
        "Varmesystemtype 0",
        "Heizsystemtyp 0=VL 4=D",
    ],
    "opt_phasemeassure_installed": [
        "Add-on phase order measurement",
        "Tillägg fasmätning",
        "Vaihejärjestysmittaus",
        "Tillegg fasemåling",
        "Ergänzung Phasenmessung",
    ],
    ...
    "opt_flowguard_installed": [
        "Add-on flow guard",
        "Tillägg flödesvakt",
        "Virtausvahti lisätty",
        "Tillegg flytvakt",
        "Ergänzung Strömungswächter",
    ],
    "internal_logging_t": [
        "Logging time",
        "Loggtid",
    ...
    "brine_runout_t": [
        "Brine run-out duration",
        "Brinetid på",
        "Keruupumpun käyntiaika",
        "Brinetid på",
        "Solepumpe Anlaufdauer",
    ],
    "brine_run_in_t": [
        "Brine run-in duration",
        "Brinetid av",
        "Keruupumpun pysähdysaika",
        "Brinetid av",
        "Solepumpe Nachlaufdauer",
    ],
    "legionella_run_on": [
        "Legionella peak heating enable",
        "Tillåt legionella körning",
        "Legionella  toiminnon käynnistys",
        "Legionella topptid aktiv",
        "Legionella Spitzenwärme aktiv",
    ],
    "legionella_run_length_h": [
        "Legionella peak heating duration",
        "Legionella topptid",
        "Legionella toiminnon huippulämmön aika",
        "Legionella topptid",
        "Legionella Spitzenwärmedauer",
    ],
    ...
    "hotwater_runtime_h": [
        "Runtime hotwater production",
        "Drifttid varmv.prod. med kompr.",
        "Käyttöaika lämminvesi (kompressorilla)",
        "Drifttid Varmtv.prod. med kompr.",
        "Betriebszeit Warmwasser",
    ],
    "msd1_dvv": ["DVV_MSD1", "DVV_MSD1", "DVV_MSD1", "DVV_MSD1", "DVV_MSD1"],
    "passive_cooling_runtime_h": [
        "Runtime passive cooling",
        "Drifttid passiv kyla",
        "Käyttöaika passiviseen viilennykseen",
        "Drifttid passiv kjøling",
        "Betriebszeit passive Kühlung",
    ],
    "msd1_dpas": ["DPAS_MSD1", "DPAS_MSD1", "DPAS_MSD1", "DPAS_MSD1", "DPAS_MSD1"],
    "active_cooling_runtime_h": [
        "Runtime active cooling",
        "Drifttid aktiv kyla",
        "Käyttöaika aktiviseen viilennykseen",
        "Drifttid aktiv kjøling",
    ...
    "room_sensor_set_t": [
        "Room sensor, Set actual",
        "Rums sensor, Sätt nuvarande",
        "Huoneanturin tavoitelämpötila",
        "Room sensor, Set",
        "Room sensor, Set",
    ],
    "heatpump_evu_block": [
