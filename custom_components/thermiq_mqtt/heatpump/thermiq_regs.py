...
id_names = {  
  ...
  'integral2_curve_target'       : ['Pool temp target', 'Shunt kurva, bör', 'Shuntin käyrä, haluttu', 'Shunt Kurve, bør', 'Mischer Kurve, Soll'],
  'integral2_curve_actual'       : ['Pool temp actual', 'Shunt kurva, är', 'Shuntin käyrä, lämpötila', 'Shunt kurve, er', 'Mischer Kurve, Ist'],
